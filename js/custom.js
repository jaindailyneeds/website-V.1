// ------------------------------------------------
// Project Name: Jain Daily Needs Coming Soon Template
// Project Description: Jain Daily Needs - awesome coming soon template to kick-start your project
// Tags: mix_design, Jain Daily Needs, coming soon, under construction, template, coming soon page, html5, css3
// Version: 4.0.1
...
$(function() {
  ...
  // KBW-Countdown Start
  // --------------------------------------------- //
  $('#countdown').countdown({until: $.countdown.UTCDate(+5, 2026, 1, 20), format: 'D'});
  // --------------------------------------------- //
  // KBW-Countdown End
  // --------------------------------------------- //
